...
@njit(cache=True, parallel=True)
def compute_rotational_quantities_2(
    positions: np.ndarray,
    velocities: np.ndarray,
    masses: np.ndarray,
    ref_pos: np.ndarray,
...
@njit(cache=True, parallel=True)
def compute_enclosed_mass_radii_2(
    radii: np.ndarray,
    masses: np.ndarray,
    offsets: np.ndarray,
    idx_sorted: np.ndarray,
...
@njit(cache=True, parallel=True)
def compute_virial_quantities_2(
    radii: np.ndarray,
    masses: np.ndarray,
    offsets: np.ndarray,
    idx_sorted: np.ndarray,
...
@njit(cache=True)
def compute_radii(
    positions: np.ndarray, ref_pos: np.ndarray, group_idx: np.ndarray, n_particles: int, boxsize: float
) -> np.ndarray:
    """
