...
:::{note}
The test coverage reports generated by `pytest-cov` cannot see into the numba functions which comprise the majority of the codebase. This means our test coverage numbers are much lower than in actuality.
:::
